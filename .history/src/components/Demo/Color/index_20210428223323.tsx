...
import conf_fabric from "cssfabric/lib/css-fabric/_generated/css.fabric.config.json"; // "css-fabric/_generated/css.fabric.config.json";
...
const Color = (props: Props) => {
  ...
  console.log(conf_fabric['css-config'].modules.base)
