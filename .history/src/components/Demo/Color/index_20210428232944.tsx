  ...
  return (
    <div className={"grid-h"}>
      <div className={"grid-main"}>
        ...
        <SubHeader
          title="gradients"
          description="gradients"></SubHeader>
      </div>
      <div className={"w-quarter"}>
          ...
          {Object.keys(base.color_schemes_props).map((key, index) => {
            ...
            return (
              <div className={"grid-h"}>
                ...
                <div className={"grid-main brd-all pad-all-2 txt-center bg-theme-" + key}></div>
              </div>
            );
          })}
        </SubHeader>
        <SubHeader title="palette colors" description="naafa">
          {Object.keys(base.color_palette_props).map((key, index) => {
            ...
            return (
              <div className={"grid-h"}>
                <div className="grid-main pad-all-4"> {key}</div>
                <div className={"grid-main pad-all-2 txt-center bg-theme-" + key}>*-{key}</div>
              </div>
            );
          })}
        </SubHeader>
        <SubHeader title="palette colors" description="naafa">
          {Object.keys(base.color_palette_props).map((key, index) => {
            ...
            return (
              <div className={"grid-h"}>
                <div className="grid-main pad-all-4"> {base.color_grays.gray_steps}</div>
                <div className={"grid-main pad-all-2 txt-center txt-gray-" + key}>*-{key}</div>
              </div>
            );
          })}
        </SubHeader>
