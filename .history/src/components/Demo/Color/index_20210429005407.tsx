    ...
    <div className={"grid-h"}>
      <div className={"grid-main"}>
        ...
        <SubHeader title="grays" description="naafa">
          {[...Array(base.color_grays.gray_steps)].map((key) => {
            ...
            return (
              <div className={"grid-h"}>
                ...
                <div
                  className={
                    "grid-main pad-all-2 txt-center gray-" + key
                  }>{key}</div>
              </div>
            );
          })}
      ...
      <div className={"w-quarter"}>
        ...
        <SubHeader title="palette colors" description="naafa">
          {Object.keys(base.color_palette_props).map((key:any, index) => {
            let prop = base.color_palette_props[key];
            return (
              <div className={"grid-h pad-b"}>
                <div className="grid-main pad-all-4"> {key*100}</div>
                <div
