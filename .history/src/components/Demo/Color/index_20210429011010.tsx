  ...
  return (
    <div className={"grid-h"}>
      <div className={"grid-main"}>
        ...
        <SubHeader title="grays" description="naafa">
          <div className={"grid-h grid-wrap"}>
            {[...Array(base.color_grays.gray_steps)].map((key, val) => {
              ...
              return (
                <div className={"w-8"}>
                  <div className={"h-2 pad-all-2 txt-center color-" + val * 100}>
                    color-{val*100} 
                  </div>
                </div>
              );
        ...
        <SubHeader title="background grays" description="naafa">
          <div className={"grid-h"}>
            {[...Array(base.color_grays.gray_steps)].map((key, val) => {
              val++; 
              return (
                <div className={"grid-main brd-l pad-all-1"}>
                  <div className={"h-4 pad-all-2 txt-center bg-theme-" + val * 100}>
                    {val} 
                  </div>
                </div>
              );
