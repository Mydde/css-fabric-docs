...
export const Header = (props: HeaderProps) => {
	return (
		<div className={'pad-all pad-b-16'}>
			...
			<div className={'pad-all  marg-t-8 marg-b-16'}>
				{props.description}
			</div>
		</div>
	);
	...
	return (
		<div className={'pad-all grid-main'}>
			<div className={'grid-h items-center'}>
				<div className={'w-4 brd-r txt-center'} style={{textAlign:'center'}}>-</div>
				<div className={'pad-l-4'}>
					<span className={'txt-h3 pad-all  txt-gray-700 txt-h5'}>title {props.title}</span>
