  ...
  return (
    <div className={"pad-all grid-main"}>
      <div className={"grid-h items-center"}>
        ...
        <div className={"pad-l-4 brd-l-1"}>
          <span className={"txt-h3 brd-b pad-all"}>{props.title}</span>
          <div className={"pad-all-4 txt-gray-900"}>description : {props.description}</div>
        </div>
      </div>
